...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.atype'
        db.add_column('opendata_resource', 'atype',
                      self.gf('django.db.models.fields.CharField')(default='csw:Record', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.atype'
        db.delete_column('opendata_resource', 'atype')
    ...
    models = {
        ...
        'opendata.resource': {
            ...
            'atype': ('django.db.models.fields.CharField', [], {'default': "'csw:Record'", 'max_length': '200'}),
