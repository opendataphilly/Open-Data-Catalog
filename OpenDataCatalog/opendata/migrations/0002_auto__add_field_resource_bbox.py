...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.bbox'
        db.add_column('opendata_resource', 'bbox',
                      self.gf('django.db.models.fields.TextField')(default='POLYGON ((-74.955750 40.137932,-75.280327 40.137932,-75.280327 39.865780,-74.955750 39.865780,-74.955750 40.137932))'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.bbox'
        db.delete_column('opendata_resource', 'bbox')
    ...
    models = {
        ...
        'opendata.resource': {
            ...
            'bbox': ('django.db.models.fields.TextField', [], {}),
